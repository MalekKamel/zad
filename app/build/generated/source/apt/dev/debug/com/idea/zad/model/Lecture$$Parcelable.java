    ...
    implements Parcelable, ParcelWrapper<com.idea.zad.model.Lecture>
{
    ...
    public static void write(com.idea.zad.model.Lecture lecture$$1, android.os.Parcel parcel$$1, int flags$$0, IdentityCollection identityMap$$0) {
        ...
        if (identity$$0 != -1) {
            ...
            parcel$$1 .writeString(lecture$$1 .details);
            parcel$$1 .writeInt(lecture$$1 .id);
            parcel$$1 .writeString(lecture$$1 .title);
            parcel$$1 .writeInt(lecture$$1 .categoryId);
            parcel$$1 .writeInt((lecture$$1 .isFavorite? 1 : 0));
        }
    }
    ...
    public static com.idea.zad.model.Lecture read(android.os.Parcel parcel$$3, IdentityCollection identityMap$$1) {
        ...
        if (identityMap$$1 .containsKey(identity$$1)) {
            ...
            lecture$$4 .details = parcel$$3 .readString();
            lecture$$4 .id = parcel$$3 .readInt();
            lecture$$4 .title = parcel$$3 .readString();
            lecture$$4 .categoryId = parcel$$3 .readInt();
            lecture$$4 .isFavorite = (parcel$$3 .readInt() == 1);
