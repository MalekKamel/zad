...
public class LectureSubcategoryFrag_ViewBinding implements Unbinder {
  private LectureSubcategoryFrag target;

  @UiThread
  public LectureSubcategoryFrag_ViewBinding(LectureSubcategoryFrag target, View source) {
    this.target = target;
