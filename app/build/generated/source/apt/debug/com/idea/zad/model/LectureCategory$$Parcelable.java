    ...
    implements Parcelable, ParcelWrapper<com.idea.zad.model.LectureCategory>
{
    ...
    public static void write(com.idea.zad.model.LectureCategory lectureCategory$$1, android.os.Parcel parcel$$1, int flags$$0, IdentityCollection identityMap$$0) {
        ...
        if (identity$$0 != -1) {
            ...
            parcel$$1 .writeInt(InjectionUtil.getField(int.class, com.idea.zad.model.LectureCategory.class, lectureCategory$$1, "id"));
            parcel$$1 .writeString(InjectionUtil.getField(String.class, com.idea.zad.model.LectureCategory.class, lectureCategory$$1, "title"));
        }
    }
    ...
    public static com.idea.zad.model.LectureCategory read(android.os.Parcel parcel$$3, IdentityCollection identityMap$$1) {
        ...
        if (identityMap$$1 .containsKey(identity$$1)) {
            ...
            InjectionUtil.setField(com.idea.zad.model.LectureCategory.class, lectureCategory$$4, "id", parcel$$3 .readInt());
            InjectionUtil.setField(com.idea.zad.model.LectureCategory.class, lectureCategory$$4, "title", parcel$$3 .readString());
